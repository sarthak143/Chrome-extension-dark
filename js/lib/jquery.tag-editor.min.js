                ...
                return (
                    c.each(function () {
                        var i = t(this),
                            ...
                            n = i.next(".tag-editor");
                        if ("getTags" == e)
                            s.push({ field: i[0], editor: n, tags: n.data("tags") });
                        else if ("addTag" == e) {
            ...
            return (
                ...
                t(document)
                    ...
                    .on("keydown.tag-editor", function (e) {
                        if (
                            8 == e.which ||
                            46 == e.which ||
                            (e.ctrlKey && 88 == e.which)
                        ) {
                            try {
                                var a = getSelection(),
                                    r =
                                        "INPUT" != document.activeElement.tagName
                                            ? t(a.getRangeAt(0).startContainer.parentNode).closest(
                                                ".tag-editor"
                                            )
                                            : 0;
                            } catch (e) {
                ...
                c.each(function () {
                    function e() {
                        !o.placeholder ||
                            c.length ||
                            t(".deleted, .placeholder, input", s).length ||
                            s.append(
                    ...
                    function a(e) {
                        for (
                            var a,
                            n = e.closest("li"),
                            d = e.val().replace(/ +/, " ").split(o.dregex),
                            g = e.data("old_tag"),
                            f = c.slice(0),
                            h = !1,
                            u = 0;
                        ...
                        e.attr("maxlength", o.maxLength).removeData("old_tag").val(""),
                            h ? e.blur() : e.focus(),
                            i();
                    }
                    var r = t(this),
                    ...
                    s.click(function (e, i) {
                                ...
                                : ((n = !0),
                                    ...
                                    n
                                        ? ((n = !0),
                                            ...
                                            "before" == r
                                                ? t(d)
                                                    .insertBefore(i.closest("li"))
                                                    .find(".tag-editor-tag")
                                                    .click()
                                                : "after" == r
                                                    ? t(d)
                                                        .insertAfter(i.closest("li"))
                                                        .find(".tag-editor-tag")
                                                        .click()
                                                    : t(d).appendTo(s).find(".tag-editor-tag").click(),
                                            !1)
                                        : !1);
                    }),
                        s.on("click", ".tag-editor-delete", function () {
                            if (t(this).prev().hasClass("active"))
                                return t(this).closest("li").find("input").caret(-1), !1;
                        ...
                        s.on("click", ".tag-editor-tag", function (e) {
                            ...
                            if (!t(this).hasClass("active")) {
                                var i = t(this).text(),
                                    a = Math.abs(
                                        (t(this).offset().left - e.pageX) / t(this).width()
                                    ),
                                    ...
                                    n = t(this)
                                        ...
                                        .find("input");
                                if (
                                    (n.data("old_tag", i).tagEditorInput().focus().caret(r),
                                        o.autocomplete)
                                ) {
                        ...
                        s.on("blur", "input", function (d) {
                            ...
                            var g = t(this),
                                f = g.data("old_tag"),
                                h = t.trim(
                                    g.val().replace(/ +/, " ").replace(o.dregex, o.delimiter[0])
                                );
                            if (h) {
                                if (h.indexOf(o.delimiter[0]) >= 0) return void a(g);
                                if (h != f)
                                    if (
                                        (o.forceLowercase && (h = h.toLowerCase()),
                                            (cb_val = o.beforeTagSave(r, s, c, f, h)),
                                            (h = cb_val || h),
                                            cb_val === !1)
                                    ) {
                                ...
                                if (f && o.beforeTagDelete(r, s, c, f) === !1)
                                    return g.val(f).focus(), (n = !1), void i();
                                try {
                                    g.closest("li").remove();
                                } catch (d) { }
                                f && i();
                    ...
                    s.on("keypress", "input", function (e) {
                        ...
                        s.on("keydown", "input", function (e) {
                            var i = t(this);
                            if (
                                ((37 == e.which || (!o.autocomplete && 38 == e.which)) &&
                                    !i.caret()) ||
                                (8 == e.which && !i.val())
                            ) {
                                ...
                                return (
                                    a.length
                                        ? a.click().find("input").caret(-1)
                                        : !i.val() ||
                                        (o.maxTags && s.data("tags").length >= o.maxTags) ||
                                        t(d)
                                            .insertBefore(i.closest("li"))
                                            .find(".tag-editor-tag")
                                            .click(),
                            ...
                            if (
                                (39 == e.which || (!o.autocomplete && 40 == e.which)) &&
                                i.caret() == i.val().length
                            ) {
                                var l = i.closest("li").next("li").find(".tag-editor-tag");
                                return (
                                    l.length
                                        ? l.click().find("input").caret(0)
                                        : i.val() && s.click(),
                                    !1
                                );
                            }
                            ...
                            if (
                                !(
                                    46 != e.which ||
                                    (t.trim(i.val()) && i.caret() != i.val().length)
                                )
                            ) {
                                var l = i.closest("li").next("li").find(".tag-editor-tag");
                                return (
                            ...
                            if (13 == e.which)
                                return (
                                    s.trigger("click", [
                                        i.closest("li").next("li").find(".tag-editor-tag"),
                                    ]),
                                    o.maxTags &&
                                    s.data("tags").length >= o.maxTags &&
                                    s.find("input").blur(),
                                    !1
                                );
                            if (36 != e.which || i.caret()) {
                                if (35 == e.which && i.caret() == i.val().length)
                                    s.find(".tag-editor-tag").last().click();
                                else if (27 == e.which)
                                    return (
                                        i.val(i.data("old_tag") ? i.data("old_tag") : "").blur(), !1
                                    );
                            } else s.find(".tag-editor-tag").first().click();
                        });
                    for (
                        var h = o.initialTags.length
                            ? o.initialTags
                            : r.val().split(o.dregex),
                        u = 0;
                        u < h.length && !(o.maxTags && u >= o.maxTags);
                        u++
                    ) {
